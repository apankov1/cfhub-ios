...
class AuthViewModel: ObservableObject {
    ...
    private(set) var credentials: AuthCredentials = AuthCredentials(providers: [:])
    ...
    private func validateStoredCredentials() async throws -> Bool {
        ...
        return !credentials.providers.isEmpty
    }
...
enum AuthError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .providerAddFailed(let provider, let reason):
